...
document.getElementById('login-form').addEventListener('submit', function(event) {
  ...
  hideLoginForm(); // call the function to hide the login form
});
...
const jobsListings = [
  ...
  },
  {
    ...
    "logo": "./images/the-air-filter-company.jpg",
    "new": false,
    "featured": false,
